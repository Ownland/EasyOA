...
public class ListViewSEmailAdapter extends BaseAdapter {
	...
	public ListViewSEmailAdapter(Context context, List<Email> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.title = (TextView)convertView.findViewById(R.id.email_listitem_titles);
			listItemView.sender = (TextView)convertView.findViewById(R.id.email_listitem_senders);
			listItemView.date= (TextView)convertView.findViewById(R.id.email_listitem_dates);
